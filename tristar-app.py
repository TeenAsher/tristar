...
app.config['MAIL_USERNAME'] = 'tatianashilina.usa@gmail.com'
...
class ReservationForm(FlaskForm):
    ...
    children = IntegerField('Children (please, type 0 if you will not have any):*', validators=[validators.InputRequired(), validators.NumberRange(min=0, max=30)])
...
def reservation():
    ...
    if form.validate_on_submit():
        msg = Message('Reservation request', sender='tatianashilina.usa@gmail.com', recipients=['tatianashilina.usa@gmail.com'])
